...
$email = "AkstElena@yandex.ru";
$phone = "8-903-319-73-54";
$skills = [
  [
    'name' =>'Фотошоп',        
    'percent' => 30,
...
$experience = [
  ...
  [ 
    'name' =>'Заместитель начальника экономического отдела', 
    'description' => 'Обеспечение анализа экономической деятельности по холдингу за отчетные периоды. Формирование БДР, контроль исполнения БДР. Контроль и анализ формирования себестоимости продукции. Контроль исполнения сотрудникам отдела назначенного функционала',
    'dateStart' => 'Mar 2020',
    'dateEnd' => 'Настоящее время',
  ],
  [
    'name' => 'Главный специалист экономического отдела',
    'description' => 'Обеспечение анализа экономической деятельности по организациям внутри холдига за отчетные периоды. Формирование БДР, контроль исполнения БДР. Контроль и анализ формирования себестоимости продукции.',
    'dateStart' => 'Sep 2018',
    'dateEnd' => 'Feb 2020',
  ],
  [ 
    'name' => 'Ведущий экономист',
    'description' => 'Обеспечение анализа экономической деятельности по холдингу за отчетные периоды. Формирование БДР, контроль исполнения БДР. Контроль и анализ формирования себестоимости продукции', 'dateStart' => 'Jul 2015',
    'dateEnd' => 'Aug 2018',
    ],
];
?>
